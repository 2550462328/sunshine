...
上面三个接口就可以构成一个比较完整的 Spring 容器，后面我们以**ClassPathXmlApplicationContext**来分析ApplicationContext的流程



#### 3. ClassPathXmlApplicationContext

ClassPathXmlApplicationContext 是我们在学习 Spring 过程中用的非常多的一个类，比如下面的使用代码
